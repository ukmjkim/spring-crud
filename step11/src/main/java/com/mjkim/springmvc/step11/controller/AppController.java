package com.mjkim.springmvc.step11.controller;
...
import com.mjkim.springmvc.step11.model.FileBucket;
...
import com.mjkim.springmvc.step11.util.FileValidator;
...
public class AppController {
   ...
   public String listUsers(ModelMap model) {
    ...
    public String saveUser(@Valid User user, BindingResult result,
        ...
        if (result.hasErrors()) {
        		logger.info("new user registraion failed {} ", user);
            return "registration";
        }
